...
/**
 * @typedef {object} PaymentGetParamsDto
 * @property {number} paymentId - Payment id, min 1.
 */

class PaymentGetParamsDtoModel {
    /**
     * Payment id, min 1
     * @type {number}
     */
     ...
     * @param {PaymentGetParamsDto} dto - Dto
     * @returns {PaymentGetParamsDtoModel}
     */
    static fromDto = (dto) => {
...
module.exports = { PaymentGetParamsDtoModel };
