...
/**
 * @typedef {object} MemberDeleteParamsDto
 * @property {number} memberId - Member id, min 1.
 */

class MemberDeleteParamsDtoModel {
    /**
     * Member id, min 1
     * @type {number}
     */
     ...
     * @param {MemberDeleteParamsDto} dto - Dto
     * @returns {MemberDeleteParamsDtoModel}
     */
    static fromDto = (dto) => {
...
module.exports = { MemberDeleteParamsDtoModel };
