...
/**
 * @typedef {object} JourneyDeleteParamsDto
 * @property {number} journeyId - Journey id, min 1.
 */

class JourneyDeleteParamsDtoModel {
    /**
     * Journey id, min 1
     * @type {number}
     */
     ...
     * @param {JourneyDeleteParamsDto} dto - Dto
     * @returns {JourneyDeleteParamsDtoModel}
     */
    static fromDto = (dto) => {
...
module.exports = { JourneyDeleteParamsDtoModel };
