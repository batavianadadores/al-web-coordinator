...
/**
 * @typedef {object} JourneyStepDeleteParamsDto
 * @property {number} journeyStepId - Journey step id, min 1
 */

class JourneyStepDeleteParamsDtoModel {
    /**
    ...
    /**
     * Creates a model
     * @param {JourneyStepDeleteParamsDto} dto - Dto
     * @returns {JourneyStepDeleteParamsDtoModel}
     */
    static fromDto = (dto) => {
...
module.exports = { JourneyStepDeleteParamsDtoModel };
